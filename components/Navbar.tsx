...
export default function Navbar({
  ...
  return (
    <>
      <header
        className={`w-full ${
          floating ? "fixed inset-x-0 top-0 z-50" : "sticky top-0 z-50"
        }`}
      >
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4 md:px-6">
            ...
            <div className="hidden items-center gap-6 text-sm font-medium text-slate-700 md:flex">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="rounded-xl bg-gradient-to-r from-[#3B5BDB] to-indigo-700 px-5 py-2.5 text-white font-semibold shadow-md transition hover:opacity-90"
                >
                ...
                <AnimatePresence>
                  {authOpen && (
                    <motion.div
                      {...dropdownMotion}
                      className="absolute right-0 top-full z-50 mt-3 w-52 rounded-2xl border border-white/60 bg-white/95 p-2 shadow-[0_18px_45px_rgba(15,23,42,0.2)] backdrop-blur"
                    >
  ...
  <div className="flex flex-col gap-1">
    ...
    <Link
      href="/login"
      className="rounded-xl px-4 py-3 text-sm font-medium text-slate-700 transition hover:bg-[#3B5BDB]/10 hover:text-[#3B5BDB]"
  ...
  <div className="flex flex-col gap-1">
    ...
    <div className="rounded-xl bg-slate-100 px-4 py-3 text-sm font-semibold text-[#20306f]">
      Hi, {user.name}
    </div>
    ...
    <button
      ...
      className="rounded-xl px-4 py-3 text-left text-sm font-medium text-red-500 transition hover:bg-red-50"
    >
      Logout
    </button>
