...
const stats = [
  { value: "9+", label: "Future Ready Modules" },
  { value: "60+", label: "Hours Guided Content" },
  { value: "100%", label: "Offline Learning" },
      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-8 px-4 pb-8 sm:px-6 sm:pb-10 md:grid-cols-[1.08fr_0.92fr] md:pb-24">
        ...
        >
          ...
          <p className="max-w-xl text-sm leading-relaxed text-white/90 sm:text-base md:text-lg">
            Empowering schools with future-ready technologies, hands-on learning, AI-powered education, robotics, IoT, Drone Technology, AR/VR, 3D Printing and innovation-driven learning aligned with NEP 2020.
          </p>
          <div className="flex flex-wrap items-center gap-4">
            ...
            <Link href="/our-products">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="rounded-full bg-[#FFC933] px-5 py-3 text-sm font-semibold text-[#6a4b00] shadow-lg sm:px-6"
              >
                Explore Modules
              </motion.button>
            </Link>
        ...
        >
          <div className="absolute right-0 top-0 h-[190px] w-[260px] sm:h-[220px] sm:w-[310px] md:h-[265px] md:w-[380px]">
            <Image
              src="/ai-lab/think-sphere-large-image-lab.png"
